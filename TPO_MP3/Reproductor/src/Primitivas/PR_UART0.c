...
extern uint8_t tx0_in,tx0_out;
// Indices de Recepcion
extern uint8_t rx0_in,rx0_out;
// Flags de estado de los buffers
extern uint8_t tx0_buffer_full, tx0_buffer_empty;
extern uint8_t rx0_buffer_full, rx0_buffer_empty;
