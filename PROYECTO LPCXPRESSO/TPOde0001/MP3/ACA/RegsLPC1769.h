...
//	#define		T0PR			TIMER0[ 3 ]			/** PR - PRESCALE REGISTER */
	...
	#define PCLK_CCLK_T0		(0x01 << 2)
	#define PCLK_CCLK_T1		(0x01 << 4)
	#define PREESCALER_T0		0
	#define PREESCALER_T1		100000		//pulsos cada 1ms en el contadorT1
	#define LLIMPIObITS_TxCTCR	0xFFFFFFF0
	...
	#define ISE_TIMER0			0x00000001
	#define ISE_TIMER1			0x00000002
	...
	#define CLR_MTCH_CONFIG_T1	(0x11 << 0)

	#define MATCH0_INT			(1 << 0)
	#define MATCH1_INT			(1 << 3)
	#define MATCH2_INT			(1 << 6)
	#define MATCH3_INT_RST		0x00000600
